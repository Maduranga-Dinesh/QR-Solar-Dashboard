    ...
    <div class="mx-auto w-1/4 shadow-lg p-5">
            ...
            <form action="{{ route('admin/qr/update', $qr->id) }}" method="POST">
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                        <input id="price" name="time" type="text" value="{{ $qr->time }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                        <input id="price" name="amount" type="text" value="{{ $qr->amount }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
