...
<body>
    <div>
                            ...
                            <div x-data="{show: false}" x-on:click.away="show = false" class="ml-3 relative">
                                <div>
                                    <button x-on:click="show = !show" type="button" class="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        ...
                                        <img class="h-8 w-8 rounded-full" src="https://i.ibb.co/Rc3b1z6/myy.png" alt="">
                                    </button>
                                </div>
                ...
                <div class="pt-4 pb-3 border-t border-gray-700">
                    <div class="flex items-center px-5">
                        <div class="flex-shrink-0">
                            <img class="h-10 w-10 rounded-full" src="https://i.ibb.co/Rc3b1z6/myy.png" alt="">
                        </div>
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white">Maduranga Dinesh Kularathna</div>
                            <div class="text-sm font-medium leading-none text-gray-400">mdkrangana@gmail.com</div>
                        </div>
        ...
        <main>
            <div class="max-w-7xl mx-auto py-0 sm:px-2 lg:px-2">
